...
| **Project**               | **Description**                                                                 |
|----------------------------------|-------------------------------------------------------------------------------|
| [**Neueral based Texture Compression**](https://github.com/siestanba/Neural_BTF)      | Neural network-based compression model for Bidirectional Texture Functions (BTFs), reducing storage requirements while preserving visual fidelity [exploration](https://sebastian.cafe/Neural/index.php)                     |
