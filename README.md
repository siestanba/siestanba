# **Hey, I'm Sebastian | Computer Vision enthousiast**
...
My Resume: [myCv.pdf](https://sebvstian.cafe/assets/cv.pdf) <br>
My Piece of Web: [dive in](https://sebvstian.cafe/)
...
| [**Gesture based Volume Control**](https://github.com/siestanba/HandTracking-VolumeMaster)    | Real-time hand-tracking system using MediaPipe and OpenCV to control PC volume via gestures [demonstration](https://sebvstian.cafe/assets/vid.mp4)|
